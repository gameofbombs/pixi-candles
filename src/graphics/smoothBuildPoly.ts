...
import type { SmoothGraphicsGeometry } from './SmoothGraphicsGeometry';

export interface IShapeBuildCommand {
    build(graphicsData: GraphicsData): void;
    triangulate(graphicsData: GraphicsData, target: SmoothGraphicsGeometry): void;
}
/**
 ...
 */
export const smoothBuildPoly: IShapeBuildCommand = {
